...
class Solution {
    public String toGoatLatin(String sentence) {
        ...
        for (int i =0;i<str.length;i++){
            if (Character.toLowerCase(str[i].charAt(0))=='a'
                    ||Character.toLowerCase(str[i].charAt(0))=='e'
                    ||Character.toLowerCase(str[i].charAt(0))=='i'
                    ||Character.toLowerCase(str[i].charAt(0))=='o'
                    ||Character.toLowerCase(str[i].charAt(0))=='u'){
                sb.append(str[i]);
                sb.append("ma");
