...
//    public List<List<Integer>> hh(TreeNode root,int tar,List<Integer> list){
//        if (root==null){
...
//            }
//        }
//        hh(root.left,tar-root.val,new ArrayList<>());
//
//    }

    public void pathSum(TreeNode root,int sum,int tar){
        if (root==null){
            return;
        }
        list.add(root.val);
