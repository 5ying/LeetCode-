...
class Solution {
    ...
    public boolean is(String a,String b,Map map){
        int lena = a.length();
        int lenb = b.length();
        int ia = 0;
        int ib =0;
            while (ia<lena && ib<lenb){
                if ((int)map.get(a.charAt(ia))<(int)map.get(b.charAt(ib))){
                    return true;
                }else if ((int)map.get(a.charAt(ia))>(int)map.get(b.charAt(ib))){
                    return false;
                }
                ia++;
                ib++;
